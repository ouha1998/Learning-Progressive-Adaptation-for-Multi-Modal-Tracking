...
from lib.models.patrack.vit_ce_adapter import vit_base_patch16_224_ce_adapter
from lib.utils.box_ops import box_xyxy_to_cxcywh
from lib.models.layers.adapter import Adapterwozeros

class PATrack(nn.Module):
    """ This is the base class for BATrack """

    def __init__(self, transformer, box_head, aux_loss=False, head_type="CORNER",norm_layer=nn.LayerNorm,):
        ...
        self.adapter_head = Adapterwozeros()
    ...
    def forward_head(self, cat_feature, gt_score_map=None):
        ...
        enc_opt1 = cat_feature[:, -self.feat_len_s:]  # encoder output for the search region (B, HW, C)
        #wo skip
        enc_opt = self.adapter_head(enc_opt1)
        # enc_opt1 = self.adapter_head(enc_opt)
        # enc_opt = enc_opt + enc_opt1
...
def build_patrack(cfg, training=True):
