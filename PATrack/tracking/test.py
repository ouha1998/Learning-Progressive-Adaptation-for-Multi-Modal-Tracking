...
def main():
    ...
    parser.add_argument('--yaml_name', type=str, default='rgbd',
                        help='Name of tracking method.')
    parser.add_argument('--tracker_name',  default='', type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default='rgbd', type=str, help='Name of config file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='rgbd1k', help='Name of dataset (rgbd1k, depthtrack, uav, tpl, vot, tn, gott, gotv, lasot).')
